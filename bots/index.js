...
// Bot registry
//
// Single source of truth for which AI sites this tool supports. Add a new bot
// here once and it shows up everywhere: the web UI checkboxes, run_all.js,
// and `node run_one.js <key>`.
//
// TO ADD A BOT:
//   1. Copy bots/chatgpt.js to bots/newbot.js and update URL + SELECTORS.
//   2. Add one line to the BOTS array below.
// ─────────────────────────────────────────────────────────────────────────────
