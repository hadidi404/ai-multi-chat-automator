...
// Finds Chrome, then Brave, then falls back to Playwright Chromium.
//
// A profile stays with the browser that created it: Chromium seals cookies
// with an OS keychain key unique to each browser, so switching browsers on one
// profile leaves every saved login unreadable.
