...
// Sinks
//
// Extra destinations for log lines, on top of the console. server.js attaches
// one so the web UI can stream the same output the terminal shows.
//
// Sinks receive every level regardless of LOG_LEVEL — the web UI has its own
// "show details" toggle, so filtering is left to the reader.
// ─────────────────────────────────────────────────────────────────────────────
